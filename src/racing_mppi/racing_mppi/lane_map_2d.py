...
class LaneMap:
    ...
    def __init__(
        ...
        img_map = Image.fromarray((self._map * 255).astype(np.uint8), mode='L')
        img_map.save("lane_map.png")
    ...
    def initialize_map(self, map_size: Tuple[int, int], cell_size: float) -> None:
        ...
        # self._cell_map_origin = np.array([-21.25772567260448,-70.80398789934522])
        self._cell_map_origin = np.array([int(round(21.25772567260448) / self._cell_size), int(round(70.80398789934522) / self._cell_size)])
